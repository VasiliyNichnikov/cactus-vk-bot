...
class Server:
    dict_phrase_bot = {
        '/start': 'Я рад, что ты решил воспользоваться моим сервисом.' 
                  'Прежде чем начать, активируй меня. Для этого перейди на сайт - https://website-computer-manager.herokuapp.com/.' 
                  'На сайте зайди в параметры -> информация и скопируй ключ. Этот ключ нужно указать в команде /key <ваш ключ>.' 
                  'Если что-то не понятно, посмотрите видео - https://youtu.be/8KeRd3Xg1KQ',
        ...
        'programs_not_found': 'Ошибка! Программы не найдены.'
                              ...
                              'Посмотрите видео, если есть проблемы с созданием программ - https://youtu.be/8KeRd3Xg1KQ',
        ...
        'scenarios_not_found': 'Ошибка! Сценарии не найдены.Убедитесь, что вы создали сценарий на сайте.Посмотрите видео, если есть проблемы с созданием сценария - https://youtu.be/8KeRd3Xg1KQ',
